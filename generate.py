...
#   python evaluate.py --style factual  --pred /kaggle/working/gen_factual.json
...
# ---------- load the generated captions (reads the caption from the style key) ----------
def load_preds(path, style):
    ...
    for d in items:
        ...
        iid = d.get('image_id') or d.get('image') or d.get('id')
        cap = d.get(style) or d.get('caption') or d.get('text')

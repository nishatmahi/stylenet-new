...
if __name__ == '__main__':
    ...
    parser.add_argument('--humorous_caption_path', type=str, default='/kaggle/input/dataset/data/factual_caption.txt',
    ...
    parser.add_argument('--epoch_num', type=int, default=76)
